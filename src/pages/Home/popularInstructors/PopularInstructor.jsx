        ...
        <div>
            <Fade duration={3000}>
                <div className="text-center my-10">
                    ...
                    <p className="text-4xl md:text-5xl font-bold text-black uppercase border-b-4 py-4 w-6/12 mx-auto">Popular Instructors</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">

                    {
                        classes.map(item => <div key={item._id}>
                            ...
                            <div className="card w-96 shadow image-full mx-auto">
